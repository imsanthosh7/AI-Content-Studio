  ...
  return (
    <div className="bg-surface rounded-xl shadow-sm border border-gray-200">
      <div className="border-b border-gray-200 px-6 py-4">
        <h3 className="text-lg font-medium text-secondary">API Status</h3>
      </div>
      <div className="p-6">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">Gemini Flash API</span>
          ...
          {!hasError && (
            <>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-secondary">~1.2s avg</span>
              </div>
            </>
          )}
          ...
          {/* Error State */}
          {hasError && (
            <div data-testid="status-api-error" className="p-3 bg-error/5 border border-error/20 rounded-lg">
              <div className="flex items-center space-x-2">
